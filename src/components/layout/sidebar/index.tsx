    ...
    <Box sx={{ display: 'flex', border: '1px solid red' }}>
      <AppBarStyle position="fixed" open={true} drawerwidth={drawerWidth}>
        ...
        >
          <DivRow>
            ...
            <DivProfile>
              <DivOne>{/* <Image src={"/svgs/bell.svg"} width={25} height={25} /> */}</DivOne>
              <DivTwo>{/* <Image src={"/svgs/search.svg"} width={25} height={25} /> */}</DivTwo>
              <DivThree>
                <Image
                  alt=""
      ...
      >
        ...
        <DIV>
          ...
          >
            {MenuITEMS.map((item) => (
              <ListItem key={item.title} sx={{ display: 'block', paddingBottom: '0px' }}>
                <ListItemButton
                  sx={{
                    minHeight: 48,
